...
const UserSelector = props => {
  ...
  const [user, setUser] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)();
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    error => {
      setError(error);
      setIsLoaded(true); // props.setAttributes( {isLoaded: true} )
      // setAttributes( {isLoaded: true} )

      console.log("ERROR: ", error);
    });
  }, []);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(users => {
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
      path: '/wp/v2/users?roles=author,editor,administrator'
    }).then(users => {
      setIsLoaded(true);
      setUsers(users);
...
/* harmony import */ var _UserSelector_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./UserSelector.js */ "./src/UserSelector.js");
...
const Edit = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Select User")
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_UserSelector_js__WEBPACK_IMPORTED_MODULE_5__["default"], {
    props: props
  }))), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('WP Engine Bio Block – hello from the editor!', 'wpenginebio'), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("showAttributes", null));
};
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('wpenginebio/wpenginebio', {
  /**
   * @see ./edit.js
   */
...
const save = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('WP Engine Bio Block – hello from the saved content!', 'wpenginebio'));
};
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwpenginebio"] = self["webpackChunkwpenginebio"] || [];
